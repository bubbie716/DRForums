/** Matches the DM recipient field: cream box, orange border + soft ring on focus, no inner outline. */
...
export const formFieldWrapperClassName =
  "form-field-wrapper rounded-xl bg-cream border border-border focus-within:border-accent focus-within:ring-2 focus-within:ring-accent/20 transition-all";

export const formFieldInnerClassName =
  "form-field-inner bg-transparent text-text-dark placeholder:text-text-muted focus:outline-none focus-visible:outline-none";
